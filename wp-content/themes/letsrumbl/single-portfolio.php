...
<div id="content">
	...
	<?php 
		...
		<?php 
			...
			<div class="back-post"><a href="<?php echo esc_url( $portfolio_main_url ); ?>" title="<?php echo __('Back to Portfolio', AZ_THEME_NAME); ?>"><i class="icon-back-pag font-icon-grid"></i></a></div>
			<?php } ?>

			<?php if( $options_alice['back_to_portfolio'] == 1 && $options_alice['back_to_portfolio_mode'] == "custom" ) { ?>
			<div class="back-post"><a href="<?php echo esc_url( $portfolio_custom_url ); ?>" title="<?php echo __('Back to Portfolio', AZ_THEME_NAME); ?>"><i class="icon-back-pag font-icon-grid"></i></a></div>
			<?php } ?>
		</div>
