...
$error_default_title = __('Nothing to see here! (404 Error)', AZ_THEME_NAME);
$error_default_subheading = __('We are really sorry but the page you requested is missing!', AZ_THEME_NAME);
$error_default_btn = __('Go Back', AZ_THEME_NAME);
