...
<div id="content">
	...
	<?php 
		...
		<?php 
			...
			<div class="back-post"><a href="<?php echo esc_url( $team_main_url ); ?>" title="<?php echo __('Back to Team', AZ_THEME_NAME); ?>"><i class="icon-back-pag font-icon-grid"></i></a></div>
			<?php } ?>

			<?php if( $options_alice['back_to_team'] == 1 && $options_alice['back_to_team_mode'] == "custom" ) { ?>
			<div class="back-post"><a href="<?php echo esc_url( $team_custom_url ); ?>" title="<?php echo __('Back to Team', AZ_THEME_NAME); ?>"><i class="icon-back-pag font-icon-grid"></i></a></div>
			<?php } ?>
		</div>
