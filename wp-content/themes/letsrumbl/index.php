...
<div id="content">
	...
	<?php if ( is_front_page() ) { ?>
	 <div class="no-page-header" style="background:purple;">
     hola
   </div>
	<?php } else { ?>
	...
	<section class="wrap_content">
		...
		<div class="infinite-scroll">
			...
			<p class="end"><?php _e( 'No More Posts', AZ_THEME_NAME ); ?></p>
			<a id="infinite-link" href="<?php echo next_posts( 0, false ); ?>"><?php _e( 'Load More Posts', AZ_THEME_NAME ); ?></a>
		</div>
