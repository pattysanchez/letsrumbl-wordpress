...
<div id="content">
	...
	<section class="wrap_content">
			...
			<div class="entry-meta-area">
				<div class="left-div">
					...
					<div class="author item-meta-area item-meta-equals">
						<span class="post-author-profile"><?php _e( 'Written by ', AZ_THEME_NAME ); ?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="<?php _e( 'Author Profile', AZ_THEME_NAME ); ?>"><?php echo get_the_author_meta( 'display_name' ); ?></a></span>
					</div>
				</div>
				<div class="right-div">
		...
		<?php 
			...
			<div class="back-post"><a href="<?php echo esc_url( $blog_main_url ); ?>" title="<?php echo __('Back to Posts', AZ_THEME_NAME); ?>"><i class="icon-back-pag font-icon-grid"></i></a></div>
			<?php } ?>
		</div>
