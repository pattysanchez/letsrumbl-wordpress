...
new WPUpdatesThemeUpdater_1277( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1277') ) {
    class WPUpdatesThemeUpdater_1277 {
